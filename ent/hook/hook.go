...
// The TripRatingFunc type is an adapter to allow the use of ordinary
// function as TripRating mutator.
type TripRatingFunc func(context.Context, *ent.TripRatingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TripRatingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TripRatingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TripRatingMutation", m)
}
...
// The UsersAdminFunc type is an adapter to allow the use of ordinary
// function as UsersAdmin mutator.
type UsersAdminFunc func(context.Context, *ent.UsersAdminMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UsersAdminFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UsersAdminMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UsersAdminMutation", m)
}
