...
// HasUserTrips applies the HasEdge predicate on the "user_trips" edge.
func HasUserTrips() predicate.User {
...
// HasUserTripsWith applies the HasEdge predicate on the "user_trips" edge with a given conditions (other predicates).
func HasUserTripsWith(preds ...predicate.Trip) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newUserTripsStep()
...
// HasUserBalance applies the HasEdge predicate on the "user_balance" edge.
func HasUserBalance() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasUserBalanceWith applies the HasEdge predicate on the "user_balance" edge with a given conditions (other predicates).
func HasUserBalanceWith(preds ...predicate.Wallet) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newUserBalanceStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasGivenRatings applies the HasEdge predicate on the "given_ratings" edge.
func HasGivenRatings() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasGivenRatingsWith applies the HasEdge predicate on the "given_ratings" edge with a given conditions (other predicates).
func HasGivenRatingsWith(preds ...predicate.TripRating) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newGivenRatingsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasReceivedRatings applies the HasEdge predicate on the "received_ratings" edge.
func HasReceivedRatings() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasReceivedRatingsWith applies the HasEdge predicate on the "received_ratings" edge with a given conditions (other predicates).
func HasReceivedRatingsWith(preds ...predicate.TripRating) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReceivedRatingsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasUserDriver applies the HasEdge predicate on the "user_driver" edge.
func HasUserDriver() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasUserDriverWith applies the HasEdge predicate on the "user_driver" edge with a given conditions (other predicates).
func HasUserDriverWith(preds ...predicate.DriverProfile) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newUserDriverStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
